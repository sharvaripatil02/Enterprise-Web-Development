...
public class DataCityServlet extends HttpServlet {
	String htmlString = "";
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			htmlString+="<div><table cellpadding=\"10\" align=\"center\"><p style=\"text-align:center;\"><b>Top five cities based on feedbacks</p></b>";
