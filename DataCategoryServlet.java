...
public class DataCategoryServlet extends HttpServlet {

	String htmlString = "";
	ChartDataset cds = null;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			for (DBObject result : agg0.results()) {
				...
				cds.setName(bobj.getString("value"));
				cds.setPrice(Integer.parseInt(bobj.getString("ReviewValue")));
